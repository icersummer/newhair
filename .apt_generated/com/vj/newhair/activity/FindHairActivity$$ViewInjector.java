...
public class FindHairActivity$$ViewInjector {
  public static void inject(Finder finder, final com.vj.newhair.activity.FindHairActivity target, Object source) {
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131099703' for field 'mViewPager' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.mViewPager = (android.support.v4.view.ViewPager) view;
    view = finder.findById(source, 0);
    if (view == null) {
      throw new IllegalStateException("Required view with id '0' for field 'mRadioGroup' was not found. If this view is optional add '@Optional' annotation.");
    }
