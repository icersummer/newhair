...
/**
 * build the view of {"活动","达人秀","发型咨询","热门话题","学编发","美甲社","彩妆控","碎碎念"}
 *
 */
public class ZoneHotAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int color= mContext.getResources().getColor(R.color.hair_scan_tag_color1);// TODO mContext.getResources() is a good Class/API
		switch(position){
		case 0:
		...
		if((position+1)%2 != 0){
			// 左列
			tvTitle.setBackgroundResource(R.drawable.hot_tag_left_bg);// TODO what's differ in : setBackground() vs. setBackgroundResource
		}else {
			// 右列
